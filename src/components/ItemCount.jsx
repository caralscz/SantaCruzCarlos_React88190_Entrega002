...
//
// Si el stock es 0, deja de restar y el botón de compra debe quedar deshabilitado 
// =============================================================
  ...
  return (
    // <div style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
        <div>
            ...
            <button className='btn btn-primary btn-sm'  disabled={stock === 0} onClick={()=>onAdd(count)}>Comprar</button>
    </div>
  )
}
